      ...
      <div style={{
        ...
        <div>
          ...
          <input
            ...
            style={{
              ...
              border: `1px solid ${confirmed ? 'var(--accent-teal)' : 'var(--border-color)'}`,
              borderRadius: '6px',
              padding: '10px 12px',
              color: confirmed ? 'var(--accent-teal)' : 'var(--text-primary)',
              fontFamily: 'var(--font-mono)',
              fontSize: '14px',
              outline: 'none',
        ...
        <div style={{ display: 'flex', gap: '10px', justifyContent: 'flex-end' }}>
          ...
          <button
            ...
            disabled={!confirmed}
            style={{
              background: confirmed ? 'var(--accent-teal)' : 'var(--bg-tertiary)',
              border: 'none',
              borderRadius: '6px',
              padding: '8px 20px',
              color: confirmed ? '#ffffff' : 'var(--text-secondary)',
              fontSize: '13px',
              fontWeight: 600,
              fontFamily: 'var(--font-sans)',
              transition: 'all 0.15s',
